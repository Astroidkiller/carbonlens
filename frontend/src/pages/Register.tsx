      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        <LiquidCard className="p-8 sm:p-10" hover={false}>
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-semibold text-[var(--text)] tracking-tight">Create Account</h1>
            <p className="mt-2 text-[var(--text-muted)] font-medium">Join CarbonLens to track your footprint</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-5">
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium text-[var(--text-muted)] mb-2 ml-1">Full Name</label>
                <input
                  id="fullName"
                  type="text"
                  required
